	...
	<div class="container">
		<div class="row">
			<core:forEach var="foodItems" items="${restaurant.foodItems}">
				<div class="col-md-3">
					<div class="thumbnail">
						<core:forEach var="photos" items="${foodItems.foodPhotos}"
							varStatus="status">
						...
						<h4>
							<b>${foodItems.foodName}</b>
						</h4>
						<core:if test="${foodItems.veg}">Veg-food </core:if>
						<core:if test="${foodItems.veg==false}">NonVeg-food </core:if>
						<h5>
							Rs.${foodItems.price} &nbsp; &nbsp; &nbsp; <a
								href="/cart/addCart?restaurantName=${restaurant.name}&foodName=${foodItems.foodName}&price=${foodItems.price}&quantity=1">ADD</a>
						</h5>
