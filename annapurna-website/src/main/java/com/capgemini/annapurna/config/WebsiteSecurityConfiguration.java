...
public class WebsiteSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		 ...
		 */
		http.authorizeRequests().antMatchers("/", "/foodItems", "/search").permitAll()//.antMatchers("/welcome").hasAnyRole("USER", "ADMIN")
	...
	public void configureGlobal(AuthenticationManagerBuilder authenticationMgr) throws Exception {
		authenticationMgr.inMemoryAuthentication().withUser("foods").password("foods").authorities("ROLE_USER")
				.and().withUser("annapurna").password("annapurna").authorities("ROLE_USER", "ROLE_ADMIN");
	}
